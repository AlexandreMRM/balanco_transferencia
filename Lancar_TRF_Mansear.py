...
def Lancamento (CodOmie, Data, Qtde, Obs, Valor, max_tentativas=3, delay=5):
    ...
    payload = {
        ...
        "param":[
            {
            "codigo_local_estoque": 9516485361, #9516485361, #Sede
    ...
    while tentativas < max_tentativas:
        ...
        if response.status_code == 200:
            ...
            st.warning(f"Tentativa {tentativas + 1} falhou com status {response.status_code}. Tentando novamente em {delay} segundos...")
    ...
    # print("Erro ao realizar Lancamento após várias tentativas, TENTE NOVAMENTE")
    return None